...
"""Importing Fish and bear classes so we can reference them here."""
...
class River:
    ...
    def check_ages(self):
        ...
        for bears in self.bears:
            if bears.age <= 5:
                ...
                """if bears are 5 or younger, add them to the list."""
    ...
    def view_river(self) -> None:
        """A brief update on our lovely river system!"""
